################################################################
#
#  setup 16 (optim allocs et calculs du 14)
#  kuma a,b = log(1+exp(-x)), + ponctuel 0 , x et 1.
#  activation sigmoide
#  avec pénalisation
#
################################################################
...
# @time for i in 1:1e6 ; Trying.Model.fk3(0.5, -1., 1.) ; end # 0.15
# @time for i in 1:1e6 ; pdf(Beta(1.2, 3.6), 0.5) ; end # 0.34
