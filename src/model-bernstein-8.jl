...
#  With dirac density on 0. and 1. and a parameter point
#########################################################################

# w[1:end-4] for weights of Bernstein polynomial
# w[end-3] for weight on 0.
# w[end-2] for weight on 1.
# w[end-1] for weight on w[end]
# w[end] dirac
...
function Bernstein7(n::Int)
  N = n
  binom = Float64[binomial(N-5,i) for i in 0:N-5]
  w = Array(Float64, N)
